...
class ProjectState extends State<Project> {
  ...
  private updateListeners() {
    for (const listenerFn of this.listeners) {
      // send a copy of the projects array
...
abstract class Component<T extends HTMLElement, U extends HTMLElement> {
  ...
  constructor(
    templateId: string, // clone from this template
    hostElementId: string, // attach to this element
    insertAtStart: boolean = true,
    newElementId?: string // assign this id to the newly created element
  ) {
